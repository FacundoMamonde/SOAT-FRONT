<template>
  <div id="divConfigNegocio" class="h-100">
    <div class="flex-grow-1">
      <div
        id="divDatosNegocio"
        class="flex-grow-1 d-flex flex-column align-items-center mt-5"
      >
        <h3>Modificar datos del negocio</h3>
        <b-alert v-if="isNewNegocio" show variant="primary"
          >A continuación ingrese los datos de su negocio</b-alert
        >
        ...
        <b-button class="mt-3" variant="outline-primary" @click="saveData()"
          >Guardar</b-button
        >
        <!-- Mensajes -->
        ...
        <b-alert
          ...
          show
          variant="danger"
          v-if="saveError.message && isBusy == false"
        >
